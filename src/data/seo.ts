...
export const SITE_URL = 'https://www.getdaygrain.com'
...
export const privacyMeta = {
  ...
  description:
    'Privacy Policy for Daygrain Focus at getdaygrain.com — local storage, cookies, analytics, and Google AdSense disclosures.',
}
