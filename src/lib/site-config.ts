...
export const tools: ToolItem[] = [
  ...
  },
  {
    ...
    tag: "Creativity",
    desc: "Daily color mood board plus a searchable library of named colors—copy HEX, Tailwind, or CSS for any shade.",
    status: "Live",
    appPath: "/colors",
    seoTitle: "Daygrain Colors — Daily Palette & HEX / Tailwind / CSS Library",
    seoDescription:
      "Free daily color palette and named color library. Search shades and copy HEX, Tailwind tokens, or CSS—no signup.",
    keywords: [
      "color palette of the day",
      "daily color inspiration",
