...
function removeBadParentLink() {
  if (existsSync(badLink)) {
    ...
    console.log('Removed tools/data/node_modules/daygrain-hub symlink')
  }
}
...
if (!existsSync(join(modulesDir, 'vite', 'package.json'))) {
  console.error('vite was not installed into tools/data/node_modules')
  process.exit(1)
}

console.log('Data deps installed cleanly.')
