  ...
  return (
    <LegalLayout title="Privacy Policy" meta={privacyMeta} path="/privacy">
      <section>
        <h2>Overview</h2>
        <p>
          {BRAND.name} Colors is a free browser-based daily color palette at
          getdaygrain.com/colors. It works without accounts and with minimal data collection.
        </p>
      </section>
      <section>
        <h2>Data on your device</h2>
        <p>
          If you shuffle palettes, the app may save today&apos;s shuffle choice in your
          browser&apos;s <strong>localStorage</strong>. This data stays on your device unless
          you clear site data.
        </p>
      </section>
      <section>
  ...
  return (
    <LegalLayout title="Terms & Conditions" meta={termsMeta} path="/terms">
      <section>
        <h2>Acceptance</h2>
        <p>
          By using Daygrain Colors, you agree to these terms. If you do not agree, please do
          not use the app.
        </p>
      </section>
      <section>
        ...
        <p>
          Daygrain Colors is provided free for personal creative inspiration. Do not misuse
          the service, attempt to disrupt it, or use it for unlawful purposes.
        </p>
      </section>
      <section>
        <h2>No warranty</h2>
  ...
  return (
    <LegalLayout title="Disclaimer" meta={disclaimerMeta} path="/disclaimer">
      <section>
        <h2>General</h2>
        <p>
          Daygrain Colors is a color inspiration tool for informational and creative purposes
          only. It is not professional design, branding, or accessibility advice. Always
          check contrast for critical UI.
        </p>
      </section>
      <section>
