  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
        ...
        <p className="mt-2 text-sm text-charcoal-muted">Last updated: July 2026</p>
  ...
  return (
    <LegalLayout title="Privacy Policy" meta={privacyMeta} path="/privacy">
      <section>
        <h2>Overview</h2>
        <p>
          {BRAND.name} Decide is a free browser-based decision matrix at getdaygrain.com/decide.
          It works without accounts and with minimal data collection.
        </p>
      </section>
      <section>
        <h2>Data on your device</h2>
        <p>
          When you calculate a result, the app may save your options, criteria, and ratings in
          your browser&apos;s <strong>localStorage</strong>. This data stays on your device
  ...
  return (
    <LegalLayout title="Terms & Conditions" meta={termsMeta} path="/terms">
      <section>
        <h2>Acceptance</h2>
        <p>
          By using Daygrain Decide, you agree to these terms. If you do not agree, please do
          not use the app.
        </p>
      </section>
      <section>
        ...
        <p>
          Daygrain Decide is provided free for personal decision support. Do not misuse the
  ...
  return (
    <LegalLayout title="Disclaimer" meta={disclaimerMeta} path="/disclaimer">
      <section>
        <h2>General</h2>
        <p>
          Daygrain Decide is a decision helper for informational purposes only. It is not
          financial, legal, career, medical, or other professional advice. You remain
