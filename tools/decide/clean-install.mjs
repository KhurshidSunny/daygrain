...
function removeBadParentLink() {
  if (existsSync(badLink)) {
    ...
    console.log('Removed tools/decide/node_modules/daygrain-hub symlink')
  }
}
...
if (!existsSync(join(modulesDir, 'vite', 'package.json'))) {
  console.error('vite was not installed into tools/decide/node_modules')
  process.exit(1)
}

console.log('Decide deps installed cleanly.')
